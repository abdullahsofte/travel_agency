            ...
            <div class="col-lg-5">
                <div class="card my-2">
                    ...
                    <div class="card-body table-card-body">
                        <form method="post" action="{{ (@$galleryData) ? route('photo.gallery.update', $galleryData->id) : route('photo.gallery.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <table class="table table-bordered text-center" id="datatablesSimple" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr class="{{ $item->id }}">
                                        ...
                                        <td>
                                            <a href="{{ route('photo.gallery.edit', $item->id) }}" class="btn btn-edit shadow-none"><i class="fas fa-pencil-alt"></i></a>
                                            <a href="{{ route('photo.gallery.delete') }}" id="delete" data-token="{{csrf_token()}}" data-id="{{$item->id}}" class="btn btn-delete shadow-none"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
