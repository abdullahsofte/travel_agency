                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="com_name" value="{{ $com_profile->com_name }}" class="form-control form-control-sm shadow-none" id="com_name">
                                                @error('com_name') <span style="color: red">{{$message}}</span> @enderror
                                            </div>
            
                                            <label for="title" class="col-sm-3 col-form-label">Phone One</label>
                                            <div class="col-sm-9">
                                                <input type="text" name="phone" value="{{ $com_profile->phone }}" class="form-control form-control-sm shadow-none" id="phone_one">
                                            ...
                                            <label for="" class="col-sm-3 col-form-label">Email Two</label>
                                            <div class="col-sm-9">
                                                <input type="email" name="email_two" value="{{ $com_profile->email_two }}" class="form-control form-control-sm shadow-none">
                                                @error('email_two') <span style="color: red">{{$message}}</span> @enderror
                                            </div>
                                            ...
                                            <div class="col-sm-9">
                                                <textarea name="map" cols="30" rows="4" class="form-control form-control-sm shadow-none">{{ $com_profile->map }}</textarea>
                                            ...
                                            <label for="title" class="col-sm-3 col-form-label">Footer Test</label>
                                            <div class="col-sm-9">
                                                <textarea name="footer_text" rows="2" class="form-control form-control-sm shadow-none">{{ $com_profile->footer_text }}</textarea>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="linkedin" value="{{ $com_profile->linkedin }}" class="form-control form-control-sm shadow-none">
