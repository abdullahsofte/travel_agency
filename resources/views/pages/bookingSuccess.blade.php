                    ...
                    <div class="card mb-3">
                        <div class="car-body px-xl-5 px-lg-4 py-lg-5 py-4 px-2">
                            ...
                            <div class="d-flex align-items-center justify-content-center flex-column text-center mb-5">
                                <h3 class="mb-0">Your order has been placed Successfully!</h3>
                                <p class="text-md mb-0">Need any information contact this number: <a href="tel:{{ $content->phone}}"
                                        class="text-primary">{{ $content->phone}}</a></p>
                            </div>
                            <div class="d-flex align-items-center justify-content-center flex-column mb-4" id="printableArea">
